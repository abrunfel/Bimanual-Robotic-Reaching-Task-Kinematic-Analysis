...
lhData.kb = subset(lhData, lhData$trial == c(21:40))
lhData.kb.mbs = aggregate(lhData.kb, by = list(lhData.kb$subjectID), FUN = mean, na.rm = TRUE)
lhData.kb.stdbs = aggregate(lhData.kb, by = list(lhData.kb$subjectID), FUN = sd, na.rm = TRUE)

ggplot(data = lhData.kb, aes(x = lhData.kb$subjectID, y = lhData.kb$ide_c))+
  geom_boxplot()
...
colnames(lhData_MandSEMbg) = c('group', 'block', 'phase',
                     ...
                     'LFvp_FS', 'LFvp_FS_c', 'LFvp_FS_st',
                     'LFvp_CMD', 'LFvp_CMD_c', 'LFvp_CMD_st',
                     'wrong_trial', 'LFoff.bc', 'LFvp.bc', 'ide.bc', 'EP_X.bc',
